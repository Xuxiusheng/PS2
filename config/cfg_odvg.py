...
max_text_len = 256
text_encoder_type = "./data/weights/bert_base_uncased"
...
freeze_keywords = ['bert', 'tokenizer', 'backbone.0', 'input_proj', 'feat_map'] # for whole model, e.g. ['backbone.0', 'bert'] for freeze visual encoder and text encoder
# freeze_keywords = ['bert', 'tokenizer', 'backbone', 'transformer', 'input_proj', 'feat_map']
...
label_list = ['bus', 'bike', 'car', 'motor', 'person', 'rider', 'truck']
# label_list = ['pedestrian', 'people', 'bicycle', 'car', 'van', 'truck', 'bus', 'motor']