...
def main(args):
    ...
    if args.eval:
        ...
        test_stats, coco_evaluator, output = evaluate(model, criterion, postprocessors,
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        if args.output_dir:
            ...
            # utils.save_on_master(model_without_ddp.backbone[0].adain.state_dict(), './weights/style_b.pth')
        ...
        # eval
        test_stats, coco_evaluator, output = evaluate(
